...
{
    /// <inheritdoc />
    public partial class InitialLastFmSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    external_id = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: false),
                    mbid = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastfm_username = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    lastfm_session_key = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    lastfm_token = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Songs__ExternalId",
                table: "Songs",
                column: "external_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Songs__Mbid",
                table: "Songs",
                column: "mbid",
                unique: true,
