...
namespace FinalAppTemplate.Data;

public partial class FinalAppTemplateDbContext : DbContext
{
    public FinalAppTemplateDbContext()
    {
    }

    public FinalAppTemplateDbContext(DbContextOptions<FinalAppTemplateDbContext> options)
        : base(options)
    {
    }
